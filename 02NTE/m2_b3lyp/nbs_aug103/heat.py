...
def generate_bags(data, type):
    ...
    for i, refcode in enumerate(data['KOJIN ID']):
        ...
        print(summed_BoH_feature_names)
...
# Estimated data
data, mol_mass, num_mols, kojin_id = read_data('../list/Hnzpe_b3lypD3.csv')
...
# benchmark data
data2, mol_mass2, num_mols2, kojin_id = read_data('../list/Hnzpe_pwpb95.csv')
