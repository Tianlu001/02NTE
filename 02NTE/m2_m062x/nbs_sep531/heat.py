...
def read_id(kojin_id): 
    ...
    for i, refcode in enumerate(kojin_id):
        filename = '../sep531sdf/'+str(refcode).zfill(4)+'.sdf'
...
# Estimated data
data, mol_mass, num_mols, kojin_id = read_data('../list/H531_m062x.csv')
...
# benchmark data
data2, mol_mass2, num_mols2, kojin_id = read_data('../list/H531_pwpb95.csv')
