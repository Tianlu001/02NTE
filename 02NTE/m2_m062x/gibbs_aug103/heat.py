...
# Estimated data
data, mol_mass, num_mols, kojin_id = read_data('../list/Hnzpe_m062xD3.csv')
...
# benchmark data
data2, mol_mass2, num_mols2, kojin_id = read_data('../list/Hgzpe_pwpb95.csv')
enthalpy = data2['Gibbs energy'].values
y = enthalpy
